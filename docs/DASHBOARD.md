...
Quick controls show active work and setup requirements. Starting a workflow pauses combat. The emergency stop and process allowlist remain in the existing input services. No action starts merely by visiting Dashboard; browser preview cannot send game input.
